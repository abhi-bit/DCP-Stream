...
class DCPClient(MemcachedClient):
    ...
    def __init__(self, host='127.0.0.1', port=11210, timeout=5):
        ...
        # start reader thread
        self.conn = DCPClient.Reader(self)
        self.conn.start()
    ...
    class Reader(threading.Thread):
        """ Reader class receives dcp response and pairs op with opaque.
...
class DCPStream(object):
    """ DCPStream class manages the responses received from producers
